...
Eigen::MatrixXd Waypoint_transform(double x, double y, double psi, const vector<double> & ptsx, const vector<double> & ptsy) {
    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          Eigen::MatrixXd waypoints = Waypoint_transform(px,py,psi,ptsx,ptsy);
